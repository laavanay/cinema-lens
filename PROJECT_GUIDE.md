...
#### Django Application (`cinema_lens/`)
...
CMD ["gunicorn", "cinema_lens.wsgi:application", "--bind", "0.0.0.0:8000"]
```

**Build and Run:**
```bash
# Build
docker build -t cinema-lens .

# Run
docker run -p 8000:8000 -e DEBUG=False cinema-lens
...
# Initialize
eb init -p python-3.10 cinema-lens

# Create environment
eb create cinema-lens-env
...
1. **Use Production Server**
   ...
   gunicorn cinema_lens.wsgi:application
   ```
